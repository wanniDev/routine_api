...
class RoutineResult(models.Model):
    ...
    routine_id = models.ForeignKey(Routine, to_field='routine_id')  #fk
...
class RoutineDay(models.Model):
    ...
    routine_id = models.ForeignKey(Routine, to_field='routine_id')  #fk
    created_at = models.DateTimeField(default=timezone.now()) #시간
    modified_at = models.DateTimeField(default=None) #시간